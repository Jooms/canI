...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:iT1eSKKr2AfhaLguSay6esvWaQjuhrNccSDtb+VCLIg=",
        version = "v0.4.12",
    )
    ...
    go_repository(
        name = "com_gitlab_flimzy_testy",
        importpath = "gitlab.com/flimzy/testy",
        sum = "h1:4djQFwBJ1ayM681Zx7Y3+OKns/E9zAfGFsLc967jfdk=",
        version = "v0.3.2",
    )
    go_repository(
